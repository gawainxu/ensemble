...
python3 main_linear.py --backbone_model_direct "/save/SupCon/tinyimgnet_models/2/tinyimgnet_resnet18_trail_0_128_1.0/" --datasets "tinyimgnet" --trail 5
python3 main_linear.py --backbone_model_direct "/save/SupCon/tinyimgnet_models/2/tinyimgnet_resnet18_trail_0_128_0.5/" --datasets "tinyimgnet" --trail 5
python3 main_linear.py --backbone_model_direct "/save/SupCon/tinyimgnet_models/2/tinyimgnet_resnet18_trail_0_128_0.1/" --datasets "tinyimgnet" --trail 5
python3 main_linear.py --backbone_model_direct "/save/SupCon/tinyimgnet_models/2/tinyimgnet_resnet18_trail_0_128_0.05/" --datasets "tinyimgnet" --trail 5
python3 main_linear.py --backbone_model_direct "/save/SupCon/tinyimgnet_models/2/tinyimgnet_resnet18_trail_0_128_0.01/" --datasets "tinyimgnet" --trail 5
python3 main_linear.py --backbone_model_direct "/save/SupCon/tinyimgnet_models/2/tinyimgnet_resnet18_trail_0_128_0.005/" --datasets "tinyimgnet" --trail 5
